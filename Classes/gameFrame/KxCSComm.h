...
#define LOG CCLOG
#define LOGDEBUG KXLOGDEBUG
#define	LOGINFO	 KXLOGINFO
#define LOGERROR KXLOGERROR
#define LOGBATTLE KXLOGBATTLE
#else
...
#define CHECK_RETURN_NULL(success) if(!(success)) return NULL;
